export default {
    ...
    jurisdiction: {
        ...
        inputupclass: "Please enter superior",
    ...
    jurmanage: {
        inputadmin: "Please enter the administrator name",
        search: "search",
        ...
        detail: "describe",
        operation: "operation",
        delwarning: "Are you sure to delete?",
        edit: "edit",
        delete: "delete",
        distribution: "Roles",
        cancel: "cancel",
        addadminaccount: "Add Administrator User",
        photo: "head portrait",
        type: "type",
        distributiondetail: "Permission configuration needs to be configured on the list page after adding an administrator successfully",
        admin: "admin",
        inputadminpwd: "Please enter the administrator password",
        password: "password",
        nickname: "nickname",
        inputnickname: "Please enter your nickname",
        sex: "sex",
        ...
        updateadmin: "Modify administrator user",
        updatesave: "Modify Save",
        jurlisterr: "Failed to modify and save the access list. Please try again",
        deladminsuc: "Successfully deleted the administrator",
        noupdate: "You have no permission to modify, please contact the super administrator",
        jurdelerr: "Failed to delete the administrator. Please try again",
        jurdelsuc: "Successfully modified permission information",
        nodel: "You have no permission to delete, please contact the super administrator",
        jurupdateerr: "Permission modification failed, please try again",
        updatejursuc: "Successfully modified permission information",
        userlen: "Length is 3 to 8 bits",
        inputpwd: "Please enter the administrator password",
        pwdlen: "6 to 15 digits in length",
        uploadphoto: "Please upload your avatar",
        inputsex: "Please enter gender",
        inputcheckemail: "Please enter an email in the correct format",
        addadminsuc: "Administrator added successfully",
        nojuradmin: "You have no permission to add, please contact the super administrator",
        inputphoto: "Please upload your avatar",
        addadminerr: "Failed to add administrator, please try again",
        updateadminsuc: "Successfully modified the administrator",
        noupdateadmin: "You have no permission to modify, please contact the super administrator",
        updateadminerr: "Failed to modify administrator, please try again",
        inputpngjpeg: "Please upload the png or jpeg format!",
        uploadoversize: "Uploaded pictures cannot exceed 2MB!",
    }
};